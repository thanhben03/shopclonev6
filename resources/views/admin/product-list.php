                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <table id="datatable1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($CMSNT->get_list("SELECT * FROM `products` ORDER BY `stt` ASC ") as $row) {?>
                                    <tr>
                                        <td><?=$row['stt'];?></td>
                                        <td><a
                                        ...
                                        <td>
                                            <ul>
                                                <li>Đang bán (LIVE):  <b style="color: green;"><?=format_cash($CMSNT->num_rows("SELECT * FROM `accounts` WHERE `product_id` = '".$row['id']."' AND `buyer` IS NULL "));?></b> <a href="<?=base_url_admin('accounts/'.$row['id']);?>">Xem</a></li>
                                                <li>Đã bán:  <b style="color:blue;"><?=format_cash($CMSNT->num_rows("SELECT * FROM `accounts` WHERE `product_id` = '".$row['id']."' AND `buyer` IS NOT NULL "));?></b> <a href="<?=base_url_admin('account-sold/'.$row['id']);?>">Xem</a></li>
                                                <li>Die: <b style="color: red;"><?=format_cash($CMSNT->num_rows("SELECT * FROM `accounts` WHERE `product_id` = '".$row['id']."' AND `status` = 'DIE' "));?></b></li>
                                            </ul>
                                           </td>
                                        <td>
