                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill"
                                        ...
                                        aria-controls="custom-tabs-three-profile" aria-selected="false">BANK AUTO</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill"
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel"
                                    ...
                                    <form action="" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Hiển thị số lượng đã bán</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Thông báo đơn hàng mới, nạp tiền cho Admin</label>
                                                    <select class="form-control select2bs4" name="type_notice_order">
                                                        <option
                                                            <?=$CMSNT->site('type_notice_order') == 'Email' ? 'selected' : '';?>
                                                            value="Email">Email</option>
                                                        <option
                                                            <?=$CMSNT->site('type_notice_order') == 'Telegram' ? 'selected' : '';?>
                                                            value="Telegram">Telegram</option>
                                                        <option
                                                            <?=$CMSNT->site('type_notice_order') == 'Messenger' ? 'selected' : '';?>
                                                            value="Messenger">Messenger</option>
                                                    </select>
                                                    <i>Hệ thống sẽ gửi thông báo đến
                                                        <?=$CMSNT->site('type_notice_order');?> khi có đơn hàng mới hoặc
                                                        hoá đơn nạp tiền thành công.</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <i>Chọn giao diện hiển thị sản phẩm.</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Hiển thị đánh giá sản phẩm</label>
                                ...
                                <div class="tab-pane fade" id="tab9" role="tabpanel" aria-labelledby="tab9">
                                    <form action="" method="POST">
                                        ...
                                        <i>Hệ thống tạm hiển thị thông tin ví crypto để cho khách hàng nạp thủ công, đến
                                            khi có
                                            Auto sẽ có thông báo.</i>
                                        <button name="SaveSettings" class="btn btn-info btn-icon-left m-b-10"
                                            type="submit"><i class="fas fa-save mr-1"></i>Lưu Ngay</button>
                                    </form>
                                </div>
