...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-info">
            ...
            <div class="row">
                <?php foreach($CMSNT->get_list("SELECT * FROM `addons` ORDER BY id DESC ") as $addon):?>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div class="card ">
                        ...
                        <?php endif?>
                        <img class="card-img-top" width="300px" height="250px" src="<?=$addon['image'];?>"
                            alt="<?=$addon['name'];?>">
                        <div class="card-body">
                            ...
                            <button type="button"
                                onclick="modalAddon(`<?=$addon['id'];?>`,`<?=$addon['name'];?>`, `<?=format_currency($addon['price']);?>` )"
                                class="btn btn-primary float-left btn-block">MUA NGAY</button>
                            <?php else: ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-solid"
                        placeholder="<?=__('Nhập mã kích hoạt addon');?>" id="purchase_key" />
                ...
                <div class="text-center mb-3">
                    <button type="button" id="btnBuy" onclick="buyAddon()"
                        class="btn btn-primary btn-block"><?=__('KÍCH HOẠT');?></span></button>
                </div>
            </div>
        </div>
    </div>
