...
<div class="row">
    ...
    <div class="col-sm-6 col-md-6 col-lg-4 mt-4 mt-md-3">
        <div class="basic-drop-shadow p-4 shadow-showcase">
            <!--
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <p style="font-size: 13px;">--><i><?=__($product['content']);?></i></p>
                </div>
                <div class="col-md-7">
        ...
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img class="mr-1 py-1" src="<?=base_url(getRowRealtime("categories", $product['category_id'], 'image'));?>" width="25px"><?=__($product['name']);?> <?=$product['preview'] != null ? '<a href="'.base_url($product['preview']).'" target="_blank"><i class="fas fa-search"></i></a>' : '';?>
